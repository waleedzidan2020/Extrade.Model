        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryNameAr = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    CategoryNameEn = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DriverID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DrivernameEn = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    DrivernameAr = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VendorID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserID = table.Column<int>(type: "int", nullable: false),
                    BradndNameAr = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    BradndNameEr = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CientPhone", x => x.ID);
                    table.ForeignKey(
                        name: "FK_CientPhone_MarkterClient_MarkterClientID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductnameEn = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    productnameAr = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IDVendorImg = table.Column<int>(type: "int", nullable: false),
                    ImgWork = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    VendorID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorImg", x => x.ID);
                    table.ForeignKey(
                        name: "FK_VendorImg_vendor_VendorID",
                        column: x => x.VendorID,
                        principalTable: "vendor",
                        principalColumn: "VendorID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CientPhone_MarkterClientID",
                table: "CientPhone",
